...
try{(function(id,loader,u){try{u=utag.o[loader].sender[id]={}}catch(e){u=utag.sender[id]};u.ev={'view':1,'link':1,'video':1};u.o=s;u.pushlt=function(l,v){if(typeof l!="undefined")l.push(v)};u.map={"qp.reflink":"prop11","baseURL":"prop5","qp.refresh":"prop7","page_prop4":"prop4,eVar39,eVar40","fullURL":"prop6","meta.page.id":"prop20","Edition":"prop24","page_prop2":"prop2,eVar25,eVar29,eVar54,eVar55","page_prop3":"prop3,eVar37","link_or_mod":"prop10,campaign,eVar5","article_author":"prop21,eVar61","cp.TR":"prop25,eVar3","pageName":"pageName,eVar4","channel":"channel,eVar11","page_prop22":"prop22","server":"server","page_prop19":"prop19,eVar38,eVar53","qp.term":"prop18","meta.article.published":"prop23","page_prop9":"prop9","eventsPlaceholder:Home":"event12,event17","eventsPlaceholder:Summaries":"event12,event16","eventsPlaceholder:Topic":"event12","eventsPlaceholder:Author":"event12","eventsPlaceholder:Multimedia":"event12,event54","eventsPlaceholder:SaveClick":"event93","eventsPlaceholder:ShareTool":"event89","eventsPlaceholder:FeaturedVideoClick":"event36","eventsPlaceholder:EmailClick":"event12","prop8_viewMode":"prop8","page_prop53":"prop53","page_eVar59":"eVar59","page_prop13":"prop13","page_prop27":"prop27,eVar26","meta.user.exp:google_fcf":"event75","meta.article.template:snippet":"event69","page_prop1":"prop1,eVar52","meta.modlist":"eVar74","meta.testkeys":"eVar56","cp.cke":"prop70"};u.extend=[function(a,b){s.getPageName=new Function("u",""
...
+"t;");s.prop49=s.getVisitNum(365);s.prop49=s.getVisitNum('w','s_vnum','s_invisit');s.prop49=s.getVisitNum('m','s_vmonthnum','s_monthinvisit');s.prop49=s.getVisitNum('d');s.getDaysBeforeEvent=new Function(""
...
+"++]=l.substring(0,i);l=l.substring(i+d.length);}return a");s.charSet="ISO-8859-1";s.trackExternalLinks=false;s.vmk="44BD02B1";var dt=new Date();this.weekday=[];this.weekday[0]="Sunday";this.weekday[1]="Monday";this.weekday[2]="Tuesday";this.weekday[3]="Wednesday";this.weekday[4]="Thursday";this.weekday[5]="Friday";this.weekday[6]="Saturday";s.eVar31=this.weekday[dt.getDay()];s.eVar32=dt.getHours()+":00";},function(a,b){if(a=="view"){s.prop65=s.getPreviousValue(b["pageName"],'gpv_pn');}}];u.send=function(a,b,c,d,e,f,g,h,ev,evt){if(u.ev[a]||typeof u.ev.all!="undefined"){utag.DB("send:2");b.sc_events=b.sc_events||{};u.addEvent=function(v){var t=[];if(v instanceof Array){t=v.slice(0);}else{t.push(v);}
...
try{utag.o[loader].loader.LOAD(id)}catch(e){utag.loader.LOAD(id)}})('2','wsjdn.wsjpages');}catch(e){};